 ...
 * 
 */
@WebServiceClient(name = "converter", targetNamespace = "http://service/", wsdlLocation = "http://ws.docencia.ces.siani.es/a19/SecondWSProject/converter?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERTER_QNAME = new QName("http://service/", "converter");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ws.docencia.ces.siani.es/a19/SecondWSProject/converter?wsdl");
    ...
    public Converter getConverterPort() {
        return super.getPort(new QName("http://service/", "converterPort"), Converter.class);
    }
    ...
    public Converter getConverterPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "converterPort"), Converter.class, features);
    }
